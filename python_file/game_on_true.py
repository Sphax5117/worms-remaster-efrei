...
from collision import Obstacle, WallLine
...
def game_on(screen, screensize):
    ...
    obstacle_positions = [
        (565, 542),(617,542),(670,542),(565,590),(565,640),(565,690),(565,740),(565,790),(565,840),(565,890),
        (565,940),(565,990),(565,1040),(565,1090),(565,1140),(565,1190),(617,590),(617,640),(617,690),(617,740),
        (617,790),(617,840),(617,890),(617,940),(617,990),(617,1040),(617,1090),(617,1140),(617,1190),
        (670,590),(670,640),(670,690),(670,740),(670,790),(670,840),(670,890),(670,940),(670,990),(670,1040),
        (670,1090),(670,1140),(670,1190),(850,672),(850,722),(850,772),(850,822),(850,872),(850,922),
        (850,972),(850,1022),(850,1072),(850,1122),(850,1172),(850,1222),(900,672),(900,722),(900,772),
        (900,822),(900,872),(900,922),(900,972),(900,1022),(900,1072),(900,1122),(900,1172),(900,1222),
    ]
    ...
    while running:
        ...
        if cloud_x_2 < -cloud_w:
            cloud_x_2 += screen_width + cloud_w
        if cloud_x_4 < -cloud_w:
            cloud_x_4 += screen_width + cloud_w
        if cloud_x_5 < -cloud_w:
            cloud_x_5 += screen_width + cloud_w

        screen.blit(background_img, (0, 0))
        screen.blit(cloud_layer_4, (cloud_x_4, 0))
        if cloud_x_4 + cloud_w < screen_width:
            screen.blit(cloud_layer_4, (cloud_x_4 + screen_width + cloud_w, 0))
        screen.blit(cloud_layer_2, (cloud_x_2, 0))
        if cloud_x_2 + cloud_w < screen_width:
            screen.blit(cloud_layer_2, (cloud_x_2 + screen_width + cloud_w, 0))
        screen.blit(cloud_layer_5, (cloud_x_5, 0))
        if cloud_x_5 + cloud_w < screen_width:
            screen.blit(cloud_layer_5, (cloud_x_5 + screen_width + cloud_w, 0))
